...
export function SimpleHero() {
  ...
  const slides: HeroSlide[] = [
    {
      ...
      cta_url: '/catalogo',
      bg_color: 'from-blue-900 via-blue-800 to-blue-900'
    },
    {
      id: 2,
      ...
      cta_text: 'Explorar',
      cta_url: '/catalogo',
      bg_color: 'from-indigo-900 via-purple-800 to-indigo-900'
    },
    {
      id: 3,
      ...
      cta_url: '/catalogo',
      bg_color: 'from-red-900 via-orange-800 to-red-900'
    }
  ]
  ...
  return (
    <div className={`relative w-full h-screen bg-gradient-to-br ${currentSlideData.bg_color} overflow-hidden group transition-all duration-1000`}>
      {/* Content */}
