...
export default function AdminPage() {
  ...
  className="flex flex-col items-center gap-4 p-6 rounded-2xl bg-gradient-to-br from-amber-50 to-orange-50 border-2 border-amber-200 hover:border-amber-400 hover:shadow-lg transition-all active:scale-95"
>
  ...
  <div className="text-center">
    ...
    <p className="text-sm text-gray-600">Gestiona ofertas y promociones</p>
  </div>
</button>
